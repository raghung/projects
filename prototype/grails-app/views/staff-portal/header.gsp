			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			    	<ul class="nav navbar-nav">
			    		<g:if test="${curr_page == grailsApplication.config.physician.home}">
			    			<li class="active"><g:link uri="/staff-portal">Home</g:link></li>
			    		</g:if>
			    		<g:else>
			    			<li><g:link uri="/staff-portal">Home</g:link></li>
			    		</g:else>
			    		<g:if test="${curr_page == grailsApplication.config.physician.messages}">
			    			<li class="active"><g:link uri="/staff-portal/messages">Messages</g:link></li>
			    		</g:if>
			    		<g:else>
			    			<li><g:link uri="/staff-portal/messages">Messages</g:link></li>
			    		</g:else>
			    		<g:if test="${curr_page == grailsApplication.config.physician.tracker}">
			    			<li class="active"><g:link uri="/staff-portal/tracker">Tracker</g:link></li>
			    		</g:if>
			    		<g:else>
			    			<li><g:link uri="/staff-portal/tracker">Tracker</g:link></li>
			    		</g:else>
			    		<g:if test="${curr_page == grailsApplication.config.physician.information}">
			    			<li class="active"><g:link uri="/staff-portal/information">Information</g:link></li>
			    		</g:if>
			    		<g:else>
			    			<li><g:link uri="/staff-portal/information">Information</g:link></li>
			    		</g:else>
			    		<g:if test="${curr_page == grailsApplication.config.physician.community}">
			      			<li class="active"><g:link uri="/staff-portal/community">Community</g:link></li>
			      		</g:if>
			      		<g:else>
			      			<li><g:link uri="/staff-portal/community">Community</g:link></li>
			      		</g:else>
			      		<li class="dropdown">
